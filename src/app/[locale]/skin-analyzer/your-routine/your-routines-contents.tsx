      ...
      <div className="bg-main-foreground rounded-2xl p-6">
        <div className="mb-4 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              <h2 className="font-caudex text-main-button text-5xl">Morning Routine</h2>
        ...
        <div className="mt-10 space-y-6">
          {morningProducts.map((product) => (
            <ProductCard key={`morning-${product.step}`} product={product} />
          ))}
        </div>
      </div>
      ...
      <div className="bg-main-foreground rounded-2xl p-6">
        <div className="mb-4 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              <h2 className="font-caudex text-main-button text-5xl">Evening Routine</h2>
        ...
        <div className="space-y-6">
          {eveningProducts.map((product) => (
            <ProductCard key={`evening-${product.step}`} product={product} />
          ))}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex items-start gap-4 pl-4">
      ...
      <div className="flex-1">
        <h3 className="font-open-sans text-main-button text-lg font-medium">{product.name}</h3>
