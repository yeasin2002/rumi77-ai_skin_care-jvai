  ...
  return (
    <section className="relative h-[350px] w-full overflow-hidden sm:h-[400px] md:h-[450px]">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        <h2 className="font-serif text-3xl text-white italic sm:text-4xl md:text-5xl">
        ...
        <Button
          className={`${openSans.className} mt-4 rounded-full px-6 py-5 text-base font-semibold`}
        >
